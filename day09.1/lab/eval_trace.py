...
def run_test_questions(questions_file: str = "data/test_questions.json") -> list:
    ...
    """
    # Xử lý đường dẫn tương đối so với vị trí của file eval_trace.py
    base_dir = os.path.dirname(os.path.abspath(__file__))
    if not os.path.isabs(questions_file):
        questions_file = os.path.join(base_dir, questions_file)
    ...
    for i, q in enumerate(questions, 1):
        ...
        try:
            ...
            trace_dir = os.path.join(base_dir, "artifacts", "traces")
